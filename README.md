...
Self-paced labs for three Copilot customization features, taught against a real Spring Boot API
...
Every step has instructions for both **VS Code** and **Copilot CLI**.
...
There is deliberately **no** `.github/copilot-instructions.md`, `.github/skills/`, or
`.github/agents/` in this repo. Those are what you create.
